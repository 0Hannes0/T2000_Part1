...
Der LFW-Wert von 99,83 % ist dabei ein publizierter Benchmark des Modells, keine eigene Messung --- er belegt die grundsätzliche Eignung des Verfahrens, während die Feld-Tauglichkeit im eigenen Testbetrieb über die Schwellenwert-Kalibrierung am Einsatzstandort bestätigt wurde (vgl. Kap.~5.1). LFW ist als Benchmark zu beachten, dass er aus paarweisen Verifikationsaufgaben mit je zwei Bildern pro Paar besteht und wenig demographische Diversität aufweist; für einen Kiosk mit wenigen registrierten Personen ist er damit nur ein grober Richtwert, keine direkte Vorhersage der Feldleistung. Da ein Kiosk dauerhaft an einem festen Platz mit stabilem Licht steht, genügt die standortspezifische Kalibrierung einmalig bei der Inbetriebnahme. Das System ist damit passgenau auf den vorgesehenen Einsatz --- einen internen, datenschutzkonform eingewilligten Personenkreis --- zugeschnitten und dort zuverlässig. Für eine spätere Öffnung auf ein breites Publikum ließe sich die Erkennung über verschiedene Bevölkerungsgruppen hinweg zusätzlich absichern, wie es bei öffentlichen biometrischen Systemen üblich ist @buolamwini2018gendershades[S.~2--7] (vgl.~Kap.~3.7).

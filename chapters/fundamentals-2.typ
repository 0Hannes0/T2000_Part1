...
Für ein reales Kundensystem wären zusätzliche Maßnahmen erforderlich: ein explizites Opt-in-Verfahren gemäß Art.~9 Abs.~2 lit.~a DSGVO, das Recht auf Löschung gespeicherter Embeddings nach Art.~17 DSGVO [DSGVO 2016, Art.~17] sowie eine Datenschutz-Folgenabschätzung gemäß Art.~35 DSGVO [DSGVO 2016, Art.~35] für Hochrisiko-Verarbeitungen biometrischer Daten. Diese Anforderungen sind als bekannte Produktivierungs-Voraussetzungen identifiziert, liegen jedoch außerhalb des Scopes dieses Prototyps @hogenhout2025biometricprivacy[S.~2--4].

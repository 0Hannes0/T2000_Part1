...
Die CPU-Inferenz via ONNX Runtime (Begründung in Kap.~3.3) eliminiert damit auch die Infrastrukturkosten für dedizierte GPU-Instanzen, die bei Cloud-basierten Ansätzen typischerweise den dominanten Kostenfaktor darstellen.

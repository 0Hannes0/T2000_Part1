...
Gesichtsembeddings sind biometrische Daten im Sinne des Art.~9 Abs.~1 der DSGVO, da sie aus natürlichen Personen abgeleitet werden und zur eindeutigen Identifikation geeignet sind [DSGVO 2016, Art.~9 Abs.~1]. Die Verarbeitung solcher Daten besonderer Kategorie unterliegt einem strengen Rechtsrahmen, der die Identifizierbarkeit betroffener Personen als zentrales Schutzgut anerkennt @voigt2017gdpr[S.~114--120], @hogenhout2025biometricprivacy[S.~2--4].
...
Für ein reales Kundensystem wären zusätzliche Maßnahmen erforderlich: ein explizites Opt-in-Verfahren gemäß Art.~9 Abs.~2 lit.~a DSGVO, das Recht auf Löschung gespeicherter Embeddings nach Art.~17 DSGVO [DSGVO 2016, Art.~17] sowie eine Datenschutz-Folgenabschätzung gemäß Art.~35 DSGVO [DSGVO 2016, Art.~35] für Hochrisiko-Verarbeitungen biometrischer Daten @voigt2017gdpr[S.~152--160]. Diese Anforderungen sind als bekannte Produktivierungs-Voraussetzungen identifiziert, liegen jedoch außerhalb des Scopes dieses Prototyps.
...
Nachhaltigkeitsaspekte betreffen das System auf drei Ebenen. _Ökologisch_ reduziert die CPU-basierte lokale Inferenz den Energiebedarf gegenüber GPU-Cloud-Deployments erheblich: Ein ONNX-ResNet50-Durchlauf auf CPU benötigt rund 80 ms bei wenigen Watt Leistungsaufnahme, während ein äquivalenter GPU-Cloud-Call Übertragungsenergie, Serverbetrieb und Kühlleistung eines Rechenzentrums beansprucht. Die drei LLM-Calls pro Nutzersitzung (Gaze-Check, Begrüßung, Chat) sind unvermeidbar für die Kernfunktionalität; ihre Frequenz ist durch die `CANDIDATE_SECS`-Debounce-Logik bereits minimiert. _Ökonomisch_ und _sozial_ ist das Open-Source-Fundament ein Nachhaltigkeitsfaktor: Es verhindert Vendor-Lock-in, ermöglicht breite Einsatzbarkeit ohne proprietäre Abhängigkeiten und hält das System für andere Institutionen anpassbar. Sozial ist darauf hinzuweisen, dass ArcFace-basierte Erkennungssysteme je nach Zusammensetzung des Trainingsdatensatzes demographisch unterschiedliche Fehlerraten aufweisen können @buolamwini2018gendershades[S.~2--7] --- eine Einschränkung, die für einen internen Prototyp tolerierbar ist, bei einem öffentlichen Deployment aber eine demographisch ausgewogene Evaluationsstudie erfordern würde.

...
Die Abrufseite arbeitet mit einer semantischen Ähnlichkeitssuche im Embedding-Raum --- nach demselben Prinzip wie die Kosinus-Ähnlichkeit aus Kap.~2.2.1: Anfrage und Dokument werden in denselben Vektorraum übersetzt, thematische Nähe zeigt sich im Abstand der Vektoren. Das System nutzt dafür all-MiniLM-L12-v2 (SBERT-Architektur @reimers2019sbert[S.~3982--3984], 384-dimensionale Vektoren). Der konkrete Einsatz folgt in Kap.~6.2 und 6.3.

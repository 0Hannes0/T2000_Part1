...
Das entwickelte System ersetzt klassische Gaze-Estimation durch ein binäres Vision-LLM-Urteil: Das Modell entscheidet ohne benutzerspezifische Kalibrierung, ob eine Person in die Kamera schaut (Ja/Nein). Vision-Language-Modelle (VLMs) kombinieren visuelles Verstehen mit Sprachgenerierung und ermöglichen eine Aufgabenbewältigung ohne vorheriges Training auf den jeweiligen Anwendungsfall @cheng2021gazesurvey[§1, S.~1--2]. Dabei ist zu unterscheiden: Während CLIP @radford2021clip[S.~1--3] ein Foundation-Modell für Zero-Shot-Bild-Text-Abgleich darstellt und die prinzipielle Leistungsfähigkeit visuell-sprachlicher Repräsentationen belegt, wird im entwickelten System ein instruktionsgesteuertes generatives Modell (Gemini 2.5 Flash) eingesetzt, das direkt auf natürlichsprachliche Aufgabenbeschreibungen reagiert. Diese Klasse von Modellen ermöglicht die hier benötigte binäre Klassifikation --- schaut die Person in die Kamera oder nicht --- ohne kalibrierungsabhängiges Training, was sie für Szenarien mit wechselnden Nutzern an öffentlichen Terminals besonders geeignet macht.

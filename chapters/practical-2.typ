...
Ein fester JSON-Schema-Prompt zwingt das Modell, genau die drei Felder `summary`, `facts_sentences` und `facts` zurückzugeben --- die Ausgabe ist damit direkt maschinenlesbar.

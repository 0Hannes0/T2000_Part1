...
Den Schwellenwert habe ich iterativ kalibriert. Startpunkt war der Literaturwert 0,65 für ArcFace-Verifikation @deng2019arcface[S.~4--5]. Eine eigene Messreihe mit 10 Personen ergab folgendes Bild: Unter dem ursprünglichen Kamera-Setup mit stabilem Frontallicht liefern die Scores 0,83--0,93; nach einem Wechsel des Setups --- anderes Licht, veränderte Kamerahöhe --- fallen sie auf 0,49--0,74, mit einem Ausreißer bei 0,40. Der Abstand zu den Scores, die beim Vergleich einer nicht registrierten Person gegen bestehende Profile entstehen, ist dabei sehr groß: Deren Maximum lag bei 0,11, sodass ein Trennbereich von mindestens 0,38 Score-Punkten verbleibt. Mit dem Literaturwert 0,65 wurden zwei Aufnahmen aus dem veränderten Setup fälschlich als neue Person gewertet; nach Absenkung auf 0,52 stieg die Erkennungsrate auf 95,2 % (40 von 42), bei unverändert 0 Falschakzeptanzen. Die vollständige Tabellenauswertung steht in Kap.~7.1.

...
Plans:
**Wave 1**
- [x] 34-01-PLAN.md — Audit: Kap. 3 auf Anforderungsanalyse prüfen (fehlt/implizit?); Kap. 7.1 auf ROC/Threshold-Diskussion prüfen

**Wave 2** *(blocked on Wave 1)*
- [x] 34-02-PLAN.md — Umsetzung: Anforderungsanalyse in Kap. 3 einfügen; ROC/Threshold-Passage in Kap. 7.1 ergänzen
...
**Wave 3** *(blocked on Wave 2)*
- [x] 37-03-PLAN.md — Finalcheck: Kriterien 1–2 verifizieren; Zahlen plausibel und konsistent
...
**Wave 2** *(blocked on Wave 1)*
- [x] 42-02-PLAN.md — Umsetzung: an allen drei Stellen Eigenentscheidungslogik explizit formulieren (naive Lösung → Problem → Erkenntnis → Entscheidung)
...
| 42. Selbstständigkeit (5P) | 2/3 | In Progress|  |
